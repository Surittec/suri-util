 ...
 */
package br.com.surittec.util.exception;
...
/**
 * Excecao de negocio. Atraves desta classe e possivel passar mensagens que
 * serao exibidas diretamente na tela do usuario.
 * 
 * @author Lucas Lins
 *
 */
public class BusinessException extends RuntimeException {
	...
	/**
	 * Instancia uma nova BusinessException com uma mensagem de valor
	 ...
	 * <code>code</code>, uma mensagem <code>message</code> e com possíveis
	 * parâmetros em <code>messageParams</code>.
	 */
	...
	/**
	 * Instancia e lança uma nova BusinessException com uma mensagem específica
	 * de um campo <code>component</code>, uma mensagem <code>message</code> e
	 * com possíveis parâmetros em <code>messageParams</code>.
	 */
	...
	/**
	 * Instancia e lança uma nova BusinessException com uma mensagem de código
	 * <code>code</code>, específica de um campo <code>component</code>, uma
	 * mensagem <code>message</code> e com possíveis parâmetros em
	 * <code>messageParams</code>.
	 */
